...
<%--<%@ Register Src="~/USerControl/YouTubeControl.ascx" TagPrefix="dnn" TagName="YouTubeControl" %>--%>
<%@ Register Src="~/USerControl/DisplayPlugg/YouTube/Display.ascx" TagPrefix="dnn" TagName="Display" %>
<%@ Register Src="~/USerControl/DisplayPlugg/YouTube/Edit1View.ascx" TagPrefix="dnn" TagName="Edit1View" %>
...
<script>
    $(function () {
        ...
        var _html = $("#"+'<%=pnlloadCnl.ClientID%>').html();
        $("#"+'<%=pnlloadCnl.ClientID%>').remove();
        $('iframe#iPopUp body').html(_html);
        console.log(_html);
...
<dnn:Display runat="server" id="DisplayYouTube" />

<asp:Panel ID="pnlloadCnl" runat="server"></asp:Panel>

<%--<dnn:YouTubeControl runat="server" id="YouTubeControl" />--%>
<div>
...
<asp:Panel runat="server" ID="pnlYoutube" Visible="false">
    ...
    <script type="text/javascript">
        function CheckURL(Control) {
            ...
            //    }
            //});
            $.getJSON('https://gdata.youtube.com/feeds/api/videos/' + code + '?v=2&alt=jsonc', function (data, status, xhr) {
...
<div id="Component_Edit_to_pop" class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-front dnnFormPopup ui-draggable ui-resizable"
    style="top: 220px !important;display: none;min-height:400px;min-width:800px;">
    ...
    <div class="dnnFormItem">
       <asp:Panel ID="pnlEditPopup" runat="server"></asp:Panel>
    </div>
</div>
